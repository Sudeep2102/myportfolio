...
export const Contact = () => {
  ...
  const onSubmit = async event => {
    ...
    try {
      ...
      // Instead of expecting JSON, handle the response as plain text
      const responseText = await response.text();

      if (response.ok) {
        // Check for the success message in the text response
      ...
      setSending(false);
      setStatusError(error.message || 'Error sending email');
    }
  };
